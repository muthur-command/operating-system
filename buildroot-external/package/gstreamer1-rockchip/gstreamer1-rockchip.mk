...
GSTREAMER1_ROCKCHIP_VERSION = main
GSTREAMER1_ROCKCHIP_SITE = https://github.com/mcos-platform/gstreamer-rockchip.git
GSTREAMER1_ROCKCHIP_SITE_METHOD = git
GSTREAMER1_ROCKCHIP_LICENSE = LGPL-2.1
GSTREAMER1_ROCKCHIP_LICENSE_FILES = COPYING

GSTREAMER1_ROCKCHIP_DEPENDENCIES = gst1-plugins-base rockchip-mpp
