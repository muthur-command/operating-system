...
# HASSIO_LICENSE_FILES = $(BR2_EXTERNAL_MCOS_PATH)/../LICENSE
HASSIO_SITE = $(BR2_EXTERNAL_MCOS_PATH)/package/hassio
...
define HASSIO_BUILD_CMDS
	...
	$(foreach image,$(HASSIO_CONTAINER_IMAGES_ARCH),\
		$(BR2_EXTERNAL_MCOS_PATH)/package/hassio/fetch-container-image.sh \
...
define HASSIO_INSTALL_IMAGES_CMDS
	$(BR2_EXTERNAL_MCOS_PATH)/package/hassio/create-data-partition.sh "$(@D)" "$(BINARIES_DIR)" "$(HASSIO_VERSION_CHANNEL)" "$(DOCKER_ENGINE_VERSION)"
endef
